###########################################################################
## Makefile generated for component 'Pendulum_controller'. 
## 
## Makefile     : Pendulum_controller.mk
## Generated on : Thu Nov 06 16:13:41 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Pendulum_controller.rt-win64
...
PRODUCT_NAME              = Pendulum_controller
MAKEFILE                  = Pendulum_controller.mk
...
COMPILER_COMMAND_FILE     = Pendulum_controller_comp.rsp
CMD_FILE                  = Pendulum_controller.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Pendulum_controller.rt-win64
...
DEFINES_STANDARD = -DMODEL=Pendulum_controller -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller.c $(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller_data.c $(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller_main.c $(START_DIR)\Pendulum_controller_quarc_win64\rtGetNaN.c $(START_DIR)\Pendulum_controller_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Pendulum_controller.obj Pendulum_controller_data.obj Pendulum_controller_main.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Pendulum_controller_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Pendulum_controller_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Pendulum_controller.obj : "$(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller.c"


Pendulum_controller_data.obj : "$(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller_data.c"


Pendulum_controller_main.obj : "$(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller_quarc_win64\Pendulum_controller_main.c"


rtGetNaN.obj : "$(START_DIR)\Pendulum_controller_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Pendulum_controller_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller_quarc_win64\rt_nonfinite.c"
