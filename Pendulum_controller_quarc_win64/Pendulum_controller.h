...
#ifndef Pendulum_controller_h_
#define Pendulum_controller_h_
#ifndef Pendulum_controller_COMMON_INCLUDES_
#define Pendulum_controller_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                /* Pendulum_controller_COMMON_INCLUDES_ */
...
#define Pendulum_controller_rtModel    RT_MODEL_Pendulum_controller_T
...
typedef struct {
  ...
  real_T Ei;                           /* '<Root>/MATLAB Function' */
...
#define rtB                            Pendulum_controller_B
#define BlockIO                        B_Pendulum_controller_T
#define rtX                            Pendulum_controller_X
#define ContinuousStates               X_Pendulum_controller_T
#define rtXdot                         Pendulum_controller_XDot
#define StateDerivatives               XDot_Pendulum_controller_T
#define tXdis                          Pendulum_controller_XDis
#define StateDisabled                  XDis_Pendulum_controller_T
#define rtP                            Pendulum_controller_P
#define Parameters                     P_Pendulum_controller_T
#define rtDWork                        Pendulum_controller_DW
#define D_Work                         DW_Pendulum_controller_T

/* Parameters (default storage) */
struct P_Pendulum_controller_T_ {
...
struct tag_RTM_Pendulum_controller_T {
  const char_T *path;
...
extern P_Pendulum_controller_T Pendulum_controller_P;

/* Block signals (default storage) */
extern B_Pendulum_controller_T Pendulum_controller_B;

/* Continuous states (default storage) */
extern X_Pendulum_controller_T Pendulum_controller_X;

/* Disabled states (default storage) */
extern XDis_Pendulum_controller_T Pendulum_controller_XDis;

/* Block states (default storage) */
extern DW_Pendulum_controller_T Pendulum_controller_DW;

/* External data declarations for dependent source files */
extern const real_T Pendulum_controller_RGND;/* real_T ground */

/* Model entry point functions */
extern void Pendulum_controller_initialize(void);
extern void Pendulum_controller_output(void);
extern void Pendulum_controller_update(void);
extern void Pendulum_controller_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Pendulum_controller_rtModel *Pendulum_controller(void);
...
extern RT_MODEL_Pendulum_controller_T *const Pendulum_controller_M;
 ...
 *
 * '<Root>' : 'Pendulum_controller'
 * '<S1>'   : 'Pendulum_controller/Enable Balance Control'
 * '<S2>'   : 'Pendulum_controller/MATLAB Function'
 * '<S3>'   : 'Pendulum_controller/Qube With Pendulum'
 * '<S4>'   : 'Pendulum_controller/Radians to Degrees'
 * '<S5>'   : 'Pendulum_controller/Radians to Degrees1'
 * '<S6>'   : 'Pendulum_controller/Qube With Pendulum/Counts to Angles'
 * '<S7>'   : 'Pendulum_controller/Qube With Pendulum/Qube-Servo 3 - IO (QAL)'
 * '<S8>'   : 'Pendulum_controller/Qube With Pendulum/State X'
 */
#endif                                 /* Pendulum_controller_h_ */
