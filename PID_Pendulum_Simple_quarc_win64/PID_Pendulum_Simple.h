...
#ifndef PID_Pendulum_Simple_h_
#define PID_Pendulum_Simple_h_
#ifndef PID_Pendulum_Simple_COMMON_INCLUDES_
#define PID_Pendulum_Simple_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                /* PID_Pendulum_Simple_COMMON_INCLUDES_ */
...
#define PID_Pendulum_Simple_rtModel    RT_MODEL_PID_Pendulum_Simple_T
...
typedef struct {
  ...
  real_T integral_sum;                 /* '<Root>/controller' */
  real_T prev_err;                     /* '<Root>/controller' */
  ...
  boolean_T doneDoubleBufferReInit;    /* '<Root>/controller' */
  boolean_T integral_sum_not_empty;    /* '<Root>/controller' */
  boolean_T prev_err_not_empty;        /* '<Root>/controller' */
  t_boolean HILReadTimebase_DigitalBuffer;/* '<S7>/HIL Read Timebase' */
} DW_PID_Pendulum_Simple_T;

/* Continuous states (default storage) */
typedef struct {
  real_T alpha_dot_CSTATE;             /* '<S8>/alpha_dot' */
  real_T theta_dot_CSTATE;             /* '<S8>/theta_dot' */
} X_PID_Pendulum_Simple_T;

/* State derivatives (default storage) */
typedef struct {
  real_T alpha_dot_CSTATE;             /* '<S8>/alpha_dot' */
  real_T theta_dot_CSTATE;             /* '<S8>/theta_dot' */
} XDot_PID_Pendulum_Simple_T;

/* State disabled  */
typedef struct {
  boolean_T alpha_dot_CSTATE;          /* '<S8>/alpha_dot' */
  boolean_T theta_dot_CSTATE;          /* '<S8>/theta_dot' */
} XDis_PID_Pendulum_Simple_T;
...
#define rtB                            PID_Pendulum_Simple_B
#define BlockIO                        B_PID_Pendulum_Simple_T
#define rtX                            PID_Pendulum_Simple_X
#define ContinuousStates               X_PID_Pendulum_Simple_T
#define rtXdot                         PID_Pendulum_Simple_XDot
#define StateDerivatives               XDot_PID_Pendulum_Simple_T
#define tXdis                          PID_Pendulum_Simple_XDis
#define StateDisabled                  XDis_PID_Pendulum_Simple_T
#define rtP                            PID_Pendulum_Simple_P
#define Parameters                     P_PID_Pendulum_Simple_T
#define rtDWork                        PID_Pendulum_Simple_DW
#define D_Work                         DW_PID_Pendulum_Simple_T

/* Parameters (default storage) */
struct P_PID_Pendulum_Simple_T_ {
...
struct tag_RTM_PID_Pendulum_Simple_T {
  const char_T *path;
...
extern P_PID_Pendulum_Simple_T PID_Pendulum_Simple_P;

/* Block signals (default storage) */
extern B_PID_Pendulum_Simple_T PID_Pendulum_Simple_B;

/* Continuous states (default storage) */
extern X_PID_Pendulum_Simple_T PID_Pendulum_Simple_X;

/* Disabled states (default storage) */
extern XDis_PID_Pendulum_Simple_T PID_Pendulum_Simple_XDis;

/* Block states (default storage) */
extern DW_PID_Pendulum_Simple_T PID_Pendulum_Simple_DW;

/* External data declarations for dependent source files */
extern const real_T PID_Pendulum_Simple_RGND;/* real_T ground */

/* Model entry point functions */
extern void PID_Pendulum_Simple_initialize(void);
extern void PID_Pendulum_Simple_output(void);
extern void PID_Pendulum_Simple_update(void);
extern void PID_Pendulum_Simple_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern PID_Pendulum_Simple_rtModel *PID_Pendulum_Simple(void);
...
extern RT_MODEL_PID_Pendulum_Simple_T *const PID_Pendulum_Simple_M;
 ...
 *
 * '<Root>' : 'PID_Pendulum_Simple'
 * '<S1>'   : 'PID_Pendulum_Simple/Enable Balance Control'
 * '<S2>'   : 'PID_Pendulum_Simple/Qube With Pendulum'
 * '<S3>'   : 'PID_Pendulum_Simple/Radians to Degrees'
 * '<S4>'   : 'PID_Pendulum_Simple/Radians to Degrees1'
 * '<S5>'   : 'PID_Pendulum_Simple/controller'
 * '<S6>'   : 'PID_Pendulum_Simple/Qube With Pendulum/Counts to Angles'
 * '<S7>'   : 'PID_Pendulum_Simple/Qube With Pendulum/Qube-Servo 3 - IO (QAL)'
 * '<S8>'   : 'PID_Pendulum_Simple/Qube With Pendulum/State X'
 */
#endif                                 /* PID_Pendulum_Simple_h_ */
