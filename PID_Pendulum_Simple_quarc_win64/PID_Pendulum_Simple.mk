###########################################################################
## Makefile generated for component 'PID_Pendulum_Simple'. 
## 
## Makefile     : PID_Pendulum_Simple.mk
## Generated on : Sat Nov 22 18:04:03 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\PID_Pendulum_Simple.rt-win64
...
PRODUCT_NAME              = PID_Pendulum_Simple
MAKEFILE                  = PID_Pendulum_Simple.mk
...
COMPILER_COMMAND_FILE     = PID_Pendulum_Simple_comp.rsp
CMD_FILE                  = PID_Pendulum_Simple.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\PID_Pendulum_Simple.rt-win64
...
DEFINES_STANDARD = -DMODEL=PID_Pendulum_Simple -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple.c $(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple_data.c $(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple_main.c $(START_DIR)\PID_Pendulum_Simple_quarc_win64\rtGetNaN.c $(START_DIR)\PID_Pendulum_Simple_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = PID_Pendulum_Simple.obj PID_Pendulum_Simple_data.obj PID_Pendulum_Simple_main.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\PID_Pendulum_Simple_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\PID_Pendulum_Simple_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
PID_Pendulum_Simple.obj : "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple.c"


PID_Pendulum_Simple_data.obj : "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple_data.c"


PID_Pendulum_Simple_main.obj : "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\PID_Pendulum_Simple_main.c"


rtGetNaN.obj : "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\PID_Pendulum_Simple_quarc_win64\rt_nonfinite.c"
