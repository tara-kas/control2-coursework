###########################################################################
## Makefile generated for component 'Pendulum_controller1'. 
## 
## Makefile     : Pendulum_controller1.mk
## Generated on : Sun Nov 09 21:58:43 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Pendulum_controller1.rt-win64
...
PRODUCT_NAME              = Pendulum_controller1
MAKEFILE                  = Pendulum_controller1.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2025a
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2025a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\ethan\Documents\UCL\control2-coursework
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Pendulum_controller1_comp.rsp
CMD_FILE                  = Pendulum_controller1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Pendulum_controller1.rt-win64
...
DEFINES_STANDARD = -DMODEL=Pendulum_controller1 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1.c $(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1_data.c $(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1_main.c $(START_DIR)\Pendulum_controller1_quarc_win64\rtGetNaN.c $(START_DIR)\Pendulum_controller1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Pendulum_controller1.obj Pendulum_controller1_data.obj Pendulum_controller1_main.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Pendulum_controller1_quarc_win64}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Pendulum_controller1_quarc_win64}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Pendulum_controller1.obj : "$(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1.c"


Pendulum_controller1_data.obj : "$(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1_data.c"


Pendulum_controller1_main.obj : "$(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller1_quarc_win64\Pendulum_controller1_main.c"


rtGetNaN.obj : "$(START_DIR)\Pendulum_controller1_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller1_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Pendulum_controller1_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Pendulum_controller1_quarc_win64\rt_nonfinite.c"
