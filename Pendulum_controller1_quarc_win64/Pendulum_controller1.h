...
#ifndef Pendulum_controller1_h_
#define Pendulum_controller1_h_
#ifndef Pendulum_controller1_COMMON_INCLUDES_
#define Pendulum_controller1_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                               /* Pendulum_controller1_COMMON_INCLUDES_ */
...
#define Pendulum_controller1_rtModel   RT_MODEL_Pendulum_controller1_T

/* Block signals (default storage) */
typedef struct {
  real_T Bias;                         /* '<S6>/Bias' */
  real_T Armcountstorad;               /* '<S6>/Arm: counts to rad' */
  real_T theta_dot;                    /* '<S8>/theta_dot' */
  real_T alpha_dot;                    /* '<S8>/alpha_dot' */
  real_T EnableBalanceControlSwitch;/* '<Root>/Enable Balance Control Switch' */
  real_T Gain;                         /* '<S5>/Gain' */
  real_T Gain_g;                       /* '<S4>/Gain' */
  real_T u;                            /* '<Root>/MATLAB Function' */
} B_Pendulum_controller1_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_FilterFrequency[2];/* '<S7>/HIL Initialize' */
  real_T HILReadTimebase_AnalogBuffer; /* '<S7>/HIL Read Timebase' */
  real_T HILReadTimebase_OtherBuffer[2];/* '<S7>/HIL Read Timebase' */
  real_T integral_error;               /* '<Root>/MATLAB Function' */
  real_T prev_error;                   /* '<Root>/MATLAB Function' */
  ...
  int32_T HILInitialize_DOStates;      /* '<S7>/HIL Initialize' */
  ...
  boolean_T integral_error_not_empty;  /* '<Root>/MATLAB Function' */
  boolean_T prev_error_not_empty;      /* '<Root>/MATLAB Function' */
  t_boolean HILReadTimebase_DigitalBuffer;/* '<S7>/HIL Read Timebase' */
} DW_Pendulum_controller1_T;

/* Continuous states (default storage) */
typedef struct {
  real_T theta_dot_CSTATE;             /* '<S8>/theta_dot' */
  real_T alpha_dot_CSTATE;             /* '<S8>/alpha_dot' */
} X_Pendulum_controller1_T;

/* State derivatives (default storage) */
typedef struct {
  real_T theta_dot_CSTATE;             /* '<S8>/theta_dot' */
  real_T alpha_dot_CSTATE;             /* '<S8>/alpha_dot' */
} XDot_Pendulum_controller1_T;

/* State disabled  */
typedef struct {
  boolean_T theta_dot_CSTATE;          /* '<S8>/theta_dot' */
  boolean_T alpha_dot_CSTATE;          /* '<S8>/alpha_dot' */
} XDis_Pendulum_controller1_T;
...
#define rtB                            Pendulum_controller1_B
#define BlockIO                        B_Pendulum_controller1_T
#define rtX                            Pendulum_controller1_X
#define ContinuousStates               X_Pendulum_controller1_T
#define rtXdot                         Pendulum_controller1_XDot
#define StateDerivatives               XDot_Pendulum_controller1_T
#define tXdis                          Pendulum_controller1_XDis
#define StateDisabled                  XDis_Pendulum_controller1_T
#define rtP                            Pendulum_controller1_P
#define Parameters                     P_Pendulum_controller1_T
#define rtDWork                        Pendulum_controller1_DW
#define D_Work                         DW_Pendulum_controller1_T

/* Parameters (default storage) */
struct P_Pendulum_controller1_T_ {
...
struct tag_RTM_Pendulum_controller1_T {
  const char_T *path;
...
extern P_Pendulum_controller1_T Pendulum_controller1_P;

/* Block signals (default storage) */
extern B_Pendulum_controller1_T Pendulum_controller1_B;

/* Continuous states (default storage) */
extern X_Pendulum_controller1_T Pendulum_controller1_X;

/* Disabled states (default storage) */
extern XDis_Pendulum_controller1_T Pendulum_controller1_XDis;

/* Block states (default storage) */
extern DW_Pendulum_controller1_T Pendulum_controller1_DW;

/* External data declarations for dependent source files */
extern const real_T Pendulum_controller1_RGND;/* real_T ground */

/* Model entry point functions */
extern void Pendulum_controller1_initialize(void);
extern void Pendulum_controller1_output(void);
extern void Pendulum_controller1_update(void);
extern void Pendulum_controller1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Pendulum_controller1_rtModel *Pendulum_controller1(void);
...
extern RT_MODEL_Pendulum_controller1_T *const Pendulum_controller1_M;
 ...
 *
 * '<Root>' : 'Pendulum_controller1'
 * '<S1>'   : 'Pendulum_controller1/Enable Balance Control'
 * '<S2>'   : 'Pendulum_controller1/MATLAB Function'
 * '<S3>'   : 'Pendulum_controller1/Qube With Pendulum'
 * '<S4>'   : 'Pendulum_controller1/Radians to Degrees'
 * '<S5>'   : 'Pendulum_controller1/Radians to Degrees1'
 * '<S6>'   : 'Pendulum_controller1/Qube With Pendulum/Counts to Angles'
 * '<S7>'   : 'Pendulum_controller1/Qube With Pendulum/Qube-Servo 3 - IO (QAL)'
 * '<S8>'   : 'Pendulum_controller1/Qube With Pendulum/State X'
 */
#endif                                 /* Pendulum_controller1_h_ */
